...
class ContractDropdownUI {
  ...
  enableContractNames (enable) {
    if (enable) {
      ...
      this.selectContractNames.setAttribute('title', 'Select compiled *.sol file to deploy or access contracts.')
    } else {
  ...
  enableAtAddress (enable) {
    if (enable) {
      this.atAddress.removeAttribute('disabled')
      this.atAddress.setAttribute('title', 'Select compiled *.sol file or select *.abi file to access a contract.')
    } else {
      this.atAddress.setAttribute('disabled', true)
      if (this.atAddressButtonInput.value === '') {
        this.atAddress.setAttribute('title', 'Compile *.sol file or select *.abi file and enter the address of contract to interact.')
      } else {
